...
$sql="select * from tb_peserta,tb_nilai where tb_nilai.nrp=tb_peserta.nrp order by tb_nilai.nilai desc";
if (isset($_POST["Cari"])){
  ...
  $jum=getJum($conn,$sql);
	...
	$dq=getField($conn,$sqlq);
				...
				$color="#dddddd";	
					...
					$sqlnilai= "select * from tb_nilai where nrp='$nrp'";
				$nilairow=getField($conn,$sqlnilai);
				$kd_nilai=$nilairow["kd_nilai"];
echo"<tr bgcolor='$color'>
				<td>$no</td>
					<td>Nama :  <a href='index.php?mnu=rekam_data&nrp=$nrp'>$nrp</a> - $nama ($pangkat. $korps)<br>
...
$simpan=process($conn,$sql);
		if($simpan) {echo "<script>alert('Data $kd_sertifikat berhasil disimpan !');document.location.href='?mnu=cari';</script>";}
		else{echo"<script>alert('Data $kd_sertifikat gagal disimpan...');document.location.href='?mnu=cari';</script>";}
	}
	else{
...
$ubah=process($conn,$sql);
	if($ubah) {echo "<script>alert('Data $kd_sertifikat berhasil diubah !');document.location.href='?mnu=cari';</script>";}
	else{echo"<script>alert('Data $kd_sertifikat gagal diubah...');document.location.href='?mnu=cari';</script>";}
	}//else simpan
}
?>
...
if($hapus) {echo "<script>alert('Data sertifikat $kd_sertifikat berhasil dihapus !');document.location.href='?mnu=cari';</script>";}
else{echo"<script>alert('Data sertifikat $kd_sertifikat gagal dihapus...');document.location.href='?mnu=cari';</script>";}
}
?>
