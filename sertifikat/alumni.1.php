...
$sql="select * from tb_peserta,tb_sertifikat,tb_nilai where tb_nilai.nrp=tb_sertifikat.nrp and tb_nilai.nrp=tb_peserta.nrp and tb_peserta.nrp=tb_sertifikat.nrp and tb_sertifikat.status='Diterima' and tb_nilai.keterangan = 'akhir' order by tb_nilai.nilai desc";
if (isset($_POST["Cari"])){
