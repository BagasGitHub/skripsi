...
<html lang="en">
  <head>
    ...
    <title>Sistem Informasi Penelusuran Alumni Pendidikan Dan Pelatihan Pusdiklat Bahasa Badiklat Kemhan</title>
  ...
  <section id="container" class="">
      ...
      <h5><strong>Pusdiklat Bahasa Badiklat Kemhan</strong><strong><h5>Sistem Informasi Penelusuran Alumni</strong></h5></h5>
...
$sql="select * from `tb_sertifikat` where status='Diterima' AND nrp='$nrp'";
				 ...
				 <!-- inbox notificatoin start-->
                    <li id="mail_notificatoin_bar" class="dropdown">
					 ...
					 <ul class="dropdown-menu extended inbox">
						...
						<li><p class="blue">You have 0 new messages</p></li>
<?php
	$arr=getData($conn,$sql);
		foreach($arr as $d) {							
...
?>									
  ...
  <?php if($_SESSION["cstatus"]=="Kabid Rendiklat"){//menu ?>  
                  	...
                  	<li><a href="index.php?mnu=cari"><i class="fa fa-search fa-fw"></i><strong>Cari Instruktur</strong></a></li>
...
<?php }
                        ...
                        <li><a href="index.php?mnu=home"><i class="fa fa-home fa-fw"></i><strong> Home</strong></a></li>
                      	...
                      	<li><a href="index.php?mnu=personel"><i class="fa fa-users"></i> <strong>Personel</strong></a></li>
                      	 <li class="sub-menu">
          ...
          <li><a href="index.php?mnu=pendataan"><i class="fa fa-sign-in fa-fw"></i> <strong>Pendataan Alumni</strong></a></li>
...
<li><a href="index.php?mnu=daftarkelas"><i class="fa fa-users fa-fw"></i> <strong>Daftar Kelas</strong></a></li>
...
<?php }
 ...
 <li><a href="index.php?mnu=daftarkelass"><i class="fa fa-users fa-fw"></i> <strong>Daftar Kelas</strong></a></li>
...
else if($mnu=="personel"){require_once"peserta/peserta.php";}
...
else if($mnu=="pendataan"){require_once"pendaftaran/pendaftaran.php";}
else if($mnu=="daftarkelas"){require_once"pendaftaran/daftarkelas.php";}
...
else if($mnu=="daftarkelass"){require_once"pendaftaran/daftarkelass.php";}
else if($mnu=="rekam_data"){require_once"sertifikat/rekam_data.php";}

else if($mnu=="cari"){require_once"sertifikat/alumni.php";}
else if($mnu=="cari"){require_once"sertifikat/alumni.php";}
...
if($jumb>0){
 ...
 $jum= getJum($conn,$sql);
  ...
  $kd="R".$th.$bl;//T1108001
		...
		$sql2="select `tingkat`,kd_kursus from `$tbkursus_dibuka` where kd_kursus_dibuka='$kd_kursus_dibuka'";
		$d2=getField($conn,$sql2);
		$tingkatnow=$d2["tingkat"];
		$kd_kursusnow=$d2["kd_kursus"];
		$hasil="salah";
		
		$sql="select * from `tb_sertifikat` where `nrp`='$nrp' and kd_kursus='$kd_kursusnow' order by kd_sertifikat desc";
$sdh=getJum($conn,$sql);
// 
if($sdh>0){		
	$d=getField($conn,$sql);
